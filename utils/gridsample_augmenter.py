import numpy as np
import utils.transform_torch as transform_torch
import utils.transform_cv2 as transform_cv2
...
class GridSampleAugmenter():
    ...
    def __init__(self, aug_params, input_size=112, p=0.4):
    ...
    def __call__(self, sample):
        augmented, _ = self.augment(sample)
        return augmented
